...
Router.get('/v1/stocks/:stockId',AuthCtrl.attachUser,AuthCtrl.isValidUserAny, StockCtrl.getStockByID); // Adjust path if needed
...
Router.post('/v1/stocks/add', AuthCtrl.attachUser, AuthCtrl.isValidUserAny, StockCtrl.addNewStock); // Adjust path if needed
